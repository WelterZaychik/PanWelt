package asia.welter.entity.constants;
...
//    public static final String AVATAR_DEFAULT = "https://img.88icon.com/download/jpg/20200901/3e9ce3813b7199ea9588eeb920f41208_512_512.jpg";
    ...
    public static final String REDIS_KEY_DOWNLOAD = "panwe:download:";

    public static final String REDIS_KEY_SYS_SETTING = "panwe:syssetting:";

    public static final String REDIS_KEY_USER_SPACE_USE = "panwe:user:spaceuse:";

    public static final String REDIS_KEY_USER_FILE_TEMP_SIZE = "panwe:user:file:temp:";
